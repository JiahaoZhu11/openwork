...
export default function TextInput(props: TextInputProps) {
  ...
  return (
    <label class="block">
      ...
      <input
        {...rest}
        class={`w-full rounded-xl bg-gray-2/60 px-3 py-2 text-sm text-gray-12 placeholder:text-gray-10 shadow-[0_0_0_1px_rgba(255,255,255,0.08)] focus:outline-none focus:ring-2 focus:ring-gray-6/20 disabled:opacity-50 disabled:cursor-not-allowed ${
          local.class ?? ""
        }`.trim()}
      />
